...
<Command>
    ...
    <div slot="params">
        <ParamTable input={{
            ...
            options: {
                description: "JSON representation of a [discord.js options array](https://discord.js.org/docs/packages/discord.js/14.25.1/ApplicationCommandOption:TypeAlias)",
                type: "String",
                required: false
            }
        }} />
